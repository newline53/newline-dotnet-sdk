...
### UpdateSyntheticAccountCounterpartyAddressUnstructuredAddress

```csharp
UpdateSyntheticAccountCounterpartyAddressUnion.CreateUpdateSyntheticAccountCounterpartyAddressUnstructuredAddress(/* values here */);
```

### UpdateSyntheticAccountStructuredAddress

```csharp
UpdateSyntheticAccountCounterpartyAddressUnion.CreateUpdateSyntheticAccountStructuredAddress(/* values here */);
```
