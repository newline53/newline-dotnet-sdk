...
### CounterpartyAddressSyntheticAccountUnstructuredAddress

```csharp
PostCombinedTransfersCounterpartyAddressUnion.CreateCounterpartyAddressSyntheticAccountUnstructuredAddress(/* values here */);
```

### SyntheticAccountStructuredAddress

```csharp
PostCombinedTransfersCounterpartyAddressUnion.CreateSyntheticAccountStructuredAddress(/* values here */);
```
