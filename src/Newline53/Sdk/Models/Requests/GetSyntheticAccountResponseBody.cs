...
namespace Newline53.Sdk.Models.Requests
{
    ...
    public class GetSyntheticAccountResponseBody
    {
        ...
        public GetSyntheticAccountSyntheticAccountCategory? SyntheticAccountCategory { get; set; }

        /// <summary>
        /// A value indicating the overall state of this Synthetic Account.
        /// </summary>
        [JsonProperty("status")]
        public GetSyntheticAccountStatus? Status { get; set; }
        ...
        public List<GetSyntheticAccountAssetBalance?>? AssetBalances { get; set; }
        ...
        /// </summary>
        [JsonProperty("ach")]
        public GetSyntheticAccountAch? Ach { get; set; }

        [JsonProperty("instant_payment")]
        public GetSyntheticAccountInstantPayment? InstantPayment { get; set; }

        /// <summary>
        /// Contains wire-specific information. Only populated if the Synthetic Account is in the `wire_external` category.
        /// </summary>
        [JsonProperty("wire")]
        public GetSyntheticAccountWire? Wire { get; set; }
    }
}