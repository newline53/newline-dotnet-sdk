...
namespace Newline53.Sdk.Models.Requests
{
    ...
    public class GetTransferResponseBody
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public GetTransferStatus? Status { get; set; }
        ...
        public GetTransferInitiatorType? InitiatorType { get; set; }
