...
namespace Newline53.Sdk.Models.Requests
{
    ...
    /// <summary>
    /// See <a href="/reference/get_synthetic-account-types">GET /synthetic_account_types</a> for the list of available types.
    /// </summary>
    public class CreateSyntheticAccountRequest
    {
        ...
        /// </summary>
        [JsonProperty("wire")]
        public CreateSyntheticAccountWireRequest? Wire { get; set; }
    }
}