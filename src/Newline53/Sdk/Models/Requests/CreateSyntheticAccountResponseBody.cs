...
namespace Newline53.Sdk.Models.Requests
{
    ...
    public class CreateSyntheticAccountResponseBody
    {
        ...
        public CreateSyntheticAccountSyntheticAccountCategory? SyntheticAccountCategory { get; set; }

        /// <summary>
        /// A value indicating the overall state of this Synthetic Account.
        /// </summary>
        [JsonProperty("status")]
        public CreateSyntheticAccountStatus? Status { get; set; }
        ...
        public List<CreateSyntheticAccountAssetBalance?>? AssetBalances { get; set; }
        ...
        /// </summary>
        [JsonProperty("ach")]
        public CreateSyntheticAccountAchResponse? Ach { get; set; }

        [JsonProperty("instant_payment")]
        public CreateSyntheticAccountInstantPaymentResponse? InstantPayment { get; set; }

        /// <summary>
        /// Contains wire-specific information. Only populated if the Synthetic Account is in the `wire_external` category.
        /// </summary>
        [JsonProperty("wire")]
        public CreateSyntheticAccountWireResponse? Wire { get; set; }
    }
}