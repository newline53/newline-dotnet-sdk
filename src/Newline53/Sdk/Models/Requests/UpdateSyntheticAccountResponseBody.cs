...
namespace Newline53.Sdk.Models.Requests
{
    ...
    public class UpdateSyntheticAccountResponseBody
    {
        ...
        public UpdateSyntheticAccountSyntheticAccountCategory? SyntheticAccountCategory { get; set; }

        /// <summary>
        /// A value indicating the overall state of this Synthetic Account.
        /// </summary>
        [JsonProperty("status")]
        public UpdateSyntheticAccountStatus? Status { get; set; }
        ...
        public List<UpdateSyntheticAccountAssetBalance?>? AssetBalances { get; set; }
        ...
        /// </summary>
        [JsonProperty("ach")]
        public UpdateSyntheticAccountAchResponse? Ach { get; set; }

        [JsonProperty("instant_payment")]
        public UpdateSyntheticAccountInstantPaymentResponse? InstantPayment { get; set; }

        /// <summary>
        /// Contains wire-specific information. Only populated if the Synthetic Account is in the `wire_external` category.
        /// </summary>
        [JsonProperty("wire")]
        public UpdateSyntheticAccountWireResponse? Wire { get; set; }
    }
}